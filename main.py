...
def paper(paper):
    return redirect("/year/{}/paper_{}.html".format(CURRENT_YEAR, paper))


# ALPER TODO: get keynote info
@app.route("/speaker_<speaker>.html")
def speaker(speaker):
    return redirect("/year/{}/speaker_{}.html".format(CURRENT_YEAR, speaker))
...
def workshop(workshop):
    return redirect("/year/{}/workshop_{}.html".format(CURRENT_YEAR, workshop))
...
def session(session):
    return redirect("/year/{}/session_{}.html".format(CURRENT_YEAR, session))


@app.route('/event_<event>.html')
def event(event):
    return redirect("/year/{}/event_{}.html".format(CURRENT_YEAR, event))
