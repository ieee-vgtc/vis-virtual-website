...
def fill_papers_ff_links(papers, ff_dict):
    ...
    print("We mapped " + str(counter) + " ff links of total " + str(len(papers)) + " papers")
    return papers
...
if __name__ == "__main__":
    ...
    folder_with_ff_videos ="" # //TODO fill in the path to your local download of the ff-videos
