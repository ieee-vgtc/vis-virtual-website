...
# def index():
#     return render_template('year_redirect.html', site_path='index.html', site_year=2023)
...
def format_poster(v):
    ...
    return {
        ...
        "poster_pdf": "https://ieeevis.b-cdn.net/vis_2023/posters/" + v["uid"] + ".pdf",
        "summary_pdf": "https://ieeevis.b-cdn.net/vis_2023/posters/" + v["uid"] + "-summary.pdf" if v["has_summary_pdf"] == "TRUE" else None,
